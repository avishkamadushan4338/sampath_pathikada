...
export const communityOrganizationsDict: SectionDictionary<keyof CommunityOrganizationsData & string> = {
  ...
  rows: {
    ...
    nameAndAddress: { en: "Sports Society Name & Address", si: "ක්‍රීඩා සමාජවල නම හා ලිපිනය" },
    ...
    "villageDevelopmentSocieties.name": { en: "Village Development Society Names", si: "ග්‍රාම සංවර්ධන සමිතිවල නම" },
    "youthSocieties.name": { en: "Youth Society Names", si: "යෞවන සමාජ සමිතිවල නම" },
    "funeralAidSocieties.name": { en: "Funeral & Welfare Society Names", si: "අවමංගලාය හා සුභසාධක සමිතිවල නම" },
    "womensSocieties.name": { en: "Women's Society Names", si: "කාන්තා සමිතිවල නම" },
    "eldersSocieties.name": { en: "Elders' Society Names", si: "වැඩිහිටි සමිතිවල නම" },
    "childrensSocieties.name": { en: "Children's Society Names", si: "ළමා සමාජ සමිතිවල නම" },
    "samurdhiSocieties.name": { en: "Samurdhi Society Names", si: "සමෘද්ධි සමිතිවල නම" },
    "friendOrganizations.name": { en: "Friend Organization / Friend Group Names", si: "මිතුරු සංවිධාන/මිතුරු හවුල් වල නම" },
    "ngoCommittees.name": { en: "Non-Governmental Organization Names", si: "රාජ්‍ය නොවන සංවිධාන වල නම" },
    "farmerSocieties.name": { en: "Farmer Society Names", si: "ගොවි සමිතිවල නම" },
    "religiousSocieties.name": { en: "Religious Society Names", si: "ආගමික සමිතිවල නම" },
    "sanasaSocieties.name": { en: "SANASA Society Names", si: "සණස සමිතිවල නම" },
    "civilDefenseCommittees.name": { en: "Civil Defense Committee Names", si: "සිවිල් ආරක්ෂක සමිතිවල නම" },
    "prajashakthiSocieties.name": { en: "Prajashakthi Society Names", si: "ප්‍රජාශක්ති සමිතිවල නම" },
